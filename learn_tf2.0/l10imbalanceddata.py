...
file = tf.keras.utils
raw_df = pd.read_csv('/home/peihongyue/project/python/dl/data/learn/cc/creditcard.csv')
print(raw_df.head())
...
total = neg + pos
print('Examples:\n  Total: {} \n Positive: {} ({:.2f}% of total)\n'.format(total, pos, pos * 100 / total))
...
METRICS = [
    ...
    tf.keras.metrics.FalseNegatives(name='tn'),
